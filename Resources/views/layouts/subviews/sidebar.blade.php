    ...
    <nav class="sidebar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('portal.integrations') }}">
            <i class="nav-icon fa fa-handshake-o"></i> Integre ao seu ERP</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ route('portal.videos') }}">
            <i class="nav-icon fa fa-play-circle"></i> Videos tutorial</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ route('portal.documentations') }}">
            <i class="nav-icon fa fa-file-pdf-o"></i> Documentação</a>
        </li>
    </nav>
