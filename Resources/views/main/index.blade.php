			...
			<div class="card-header">
				<nav>
					<div class="nav nav-tabs" role="tablist">
						<a class="nav-item nav-link {{ ($tab==0)?'active':'' }}" href="{{ route('portal.main', 0) }}" >Configurar Empresa</a>
			...
			<div class="card-body">
				<div class="tab-content">
					<div class="tab-pane {{ ($tab==0)?'show active':'' }}" >
						@include('portal::main.subview.company')
					</div>
					...
					<div class="tab-pane {{ ($tab==3)?'show active':'' }}">
						@include('portal::main.subview.preview')
					</div>
