<div class="row my-5">
	<div class="col">
		...
		@if($export)
		<div class="d-flex justify-content-center">
			<a href="{{ route('portal.validation.download', $event_validation) }}" class="btn btn-danger btn-lg w-50 text-uppercase">BAIXAR TABELA DE {{ $event_validation->validation->alias }}</a>
		</div>
		@else
